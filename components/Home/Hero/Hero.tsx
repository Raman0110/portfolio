      ...
      <div className="flex justify-center flex-col w-4/5 h-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div>
            ...
            <p data-aos="zoom-in" data-aos-delay="300" className="mt-6 text-sm md-text-base text-white opacity-60">{BaseInfo.description}</p>

            <button data-aos="fade-left" data-aos-delay="200" className="cursor-pointer md:px-8 md:py-2.5 px-6 py-1.5 text-white font-semibold text-sm md:text-lg transition-all duration-200 rounded-lg mt-8 bg-blue-700 hover:bg-blue-900 flex items-center space-x-2">
          ...
          <div data-aos="zoom-in" data-aos-delay="400" className="mx-auto hidden lg:block rounded-[3rem] border-[3.5px] border-blue-950 overflow-hidden">
            <Image src={BaseInfo.profilePic} alt={BaseInfo.name} width={800} height={600} />
          </div>
        </div>
      </div>
    </div>

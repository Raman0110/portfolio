...
const ContactForm = () => {
  return (
    <div className="bg-[#140c1c] rounded-lg p-4 sm:p-10">
      ...
      <p className="text-gray-200 mt-3 lg:text-base text-xs md:text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum dignissimos nulla quasi nihil dolorum laboriosam?</p>
      <form className="mt-8 block w-full overflow-hidden">
        ...
        <textarea rows={7} placeholder="Message" className="w-full mt-5 bg-black text-white placeholder:text-gray-600 px-4 py-3.5 rounded-md border-[1.5px] border-gray-200 border-opacity-15 outline-none"></textarea>
        <div className="mt-4">
          <button className="px-8 py-3.5 bg-[#7947df] text-white hover:bg-[#5c2fb7] transition-all duration-150 rounded-full cursor-pointer">Send Message</button>
        </div>
      </form>
    </div>
  )
